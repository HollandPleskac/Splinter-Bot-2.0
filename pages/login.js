  ...
  return (
    <div className='h-screen flex justify-center items-center' >
      <div className='flex flex-col w-96' >
        ...
        <p onClick={navHandler} className='text-center mb-4 text-md' >Don't have an account? <span className='text-blue-600 font-semibold cursor-pointer' >Sign up!</span></p>
